  ...
  return ThemeData(
    ...
    textTheme: TextTheme(
      headline1: getSemiBoldStyle(
        ...
        fontFamily: FontConstants.fontPrimary, fontSize: FontSize.s16),
      ...
      headline4: getRegularStyle(
        color: ColorManager.darkGreen,
        fontFamily: FontConstants.fontPrimary, fontSize: FontSize.s14),
      ...
      bodyText2: getMediumStyle(
        color: ColorManager.lightPink, fontFamily: FontConstants.fontPrimary),
      caption: getRegularStyle(
        color: ColorManager.auxiliary, fontFamily: FontConstants.fontPrimary),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      hintStyle: getRegularStyle(
        fontFamily: FontConstants.fontPrimary, color: ColorManager.textFieldText),
      // label style
